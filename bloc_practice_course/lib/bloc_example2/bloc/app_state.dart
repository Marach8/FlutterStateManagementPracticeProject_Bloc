...
class AppState{
  ...
  bool operator ==(covariant AppState other){
    final otherPropertiesAreEqual = isLoading == other.isLoading 
      && loginHandle == other.loginHandle && loginError == other.loginError;

    if(notes == null && other.notes == null){return otherPropertiesAreEqual;}
    else{return otherPropertiesAreEqual && (notes?.isEqualTo(other.notes)?? false);}
  }
  
  @override
  int get hashCode => Object.hash(isLoading, loginError, loginHandle, notes);
}
